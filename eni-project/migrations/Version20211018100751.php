 ...
 */
final class Version20211018100751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant CHANGE prenom prenom VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE sortie ADD etat_id INT NOT NULL, ADD campus_id INT NOT NULL, ADD organisateur_id INT NOT NULL, ADD duree INT NOT NULL, CHANGE duree lieu_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant CHANGE prenom prenom VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE sortie ADD duree INT NOT NULL, DROP lieu_id, DROP etat_id, DROP campus_id, DROP organisateur_id, DROP duree');
    }
}
